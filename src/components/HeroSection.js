...
import HeroImg from '../assets/images/SnehalA1.jpg';
      ...
      <div className="hero">
        <div className="container">
          <h1 className="hero__heading">
            ...
            <span className="hero__name">Snehal Ambre</span>
          </h1>
          ...
          <div className="hero__info">
            <PText>
              I am a freelance Validation Program Manager and Artist, ensuring
